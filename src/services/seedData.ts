import { MediaItem, ThemeConcept, FactItem, VocabItem, QuoteItem, FeedPost } from '@/types';
...
const sampleThemes: ThemeConcept[] = [
  {
    ...
    summary: 'Religious extremism involves holding strict religious beliefs that often reject mainstream society and may justify harmful actions in the name of faith.',
    sourceUrl: 'https://en.wikipedia.org/wiki/Religious_extremism',
    userUnderstanding: 'The film explores how isolation from mainstream society can lead to extreme interpretations of religious doctrine.',
    savedForLater: true,
  ...
  },
  {
    ...
    summary: 'The tension between maintaining religious faith and experiencing moments of doubt or questioning.',
    savedForLater: false,
  ...
  },
  {
    ...
    summary: 'The pursuit of knowledge outside traditional educational institutions, often driven by personal determination.',
    userUnderstanding: 'Tara\'s journey shows how access to education can fundamentally transform one\'s worldview and opportunities.',
    savedForLater: true,
...
const sampleFacts: FactItem[] = [
  {
    ...
    content: 'Not all religious communities are isolated or extreme - the film specifically depicts fringe groups.',
    order: 0,
  ...
  },
  {
    ...
    mediaId: 'media-1',
    category: 'reference',
    content: 'References the historical persecution of early Mormon settlers in 19th century America.',
  ...
  },
  {
    ...
    mediaId: 'media-2',
    category: 'context',
    content: 'Tara Westover was raised in a survivalist Mormon family in Idaho and did not attend school until age 17.',
    order: 0,
...
const sampleVocab: VocabItem[] = [
  {
    ...
    exampleSentence: 'He was labeled an apostate after questioning the church\'s teachings.',
  ...
  },
  {
    ...
    exampleSentence: 'The missionaries would proselytize door to door in the neighborhood.',
  ...
  },
  {
    ...
    exampleSentence: 'Her mother prepared herbal tinctures for various ailments.',
...
const sampleQuotes: QuoteItem[] = [
  {
    ...
    userMeaning: 'This suggests that belief is not a conscious choice, but our actions in response to our beliefs define who we are.',
    aiMeaning: 'The quote explores the philosophical concept of doxastic voluntarism - whether we have control over what we believe.',
    isBookmarked: true,
  ...
  },
  {
    ...
    userMeaning: 'This captures the essence of self-education - the willingness to sit with confusion as part of learning.',
    isBookmarked: true,
...
const sampleFeed: FeedPost[] = [
  {
    ...
    caption: 'This theme really made me reconsider how isolation can shape belief systems.',
    visibility: 'global',
    likes: 12,
    isLiked: false,
    isSaved: false,
  ...
  },
  {
    ...
    caption: 'This quote from Educated perfectly captures the learning journey.',
    visibility: 'global',
    likes: 24,
    isLiked: false,
    isSaved: true,
